...
// @access  Private
const getMovesByGame = async (req, res) => {
  try {
...
// @access  Private
const getMovesByPlayer = async (req, res) => {
  try {
...
const updateMove = async (req, res) => {
  try {
    const { puan, mayin, odul_kazanildi, odul_kullanildi } = req.body;
...
// @access  Private
const getMineTriggeredMoves = async (req, res) => {
  try {
...
// @access  Private
const getRewardEarnedMoves = async (req, res) => {
  try {
...
// @access  Private
const getLastMoveByGame = async (req, res) => {
  try {
    const oyunId = req.params.oyunId;
